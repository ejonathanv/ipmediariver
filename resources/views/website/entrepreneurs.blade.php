<x-guest-layout title="Páginas Web para Emprendedores">
    <section class="homeCover">
        <div class="container">
            <div class="w-full md:w-7/12 mx-auto text-left md:text-center">
                <h1 class="title mb-10">
                    Páginas Web para <span class="accent">Emprendedores</span> en solo 10 días.
                </h1>
    ...
    <section class="py-10 md:py-32">
        <div class="container">
            <div class="flex flex-col md:flex-row space-y-7 md:space-y-0 w-full md:w-10/12 mx-auto md:space-x-16">
                <div class="w-full md:w-4/12">
                    <h3 class="borderBottom">
                        Tu Presencia en Línea en 10 Días: Páginas Web para Emprendedores
                    </h3>
                </div>
    ...
    <section class="py-10 md:py-32 bg-zinc-800">
        <div class="container flex flex-col md:flex-row space-y-7 md:space-y-0 items-center md:space-x-16">
            <div class="w-full md:w-1/2">
                <h2 class="text-white leading-relaxed">
                    ¿Qué incluye nuestro plan de Páginas Web para Emprendedores?
                </h2>

                <ul class="text-white mt-7 md:mt-16 flex flex-col space-y-5 text-xs md:text-sm">
                    <li>
                        <i class="fa fa-check mr-5 text-ipmr-red hidden md:inline-block"></i>
                        <span>Diseño web profesional y atractivo.</span>
                    </li>
                    <li>
                        <i class="fa fa-check mr-5 text-ipmr-red hidden md:inline-block"></i>
                        <span>Personalización de colores y estilo para que se adapte a tu marca.</span>
                    </li>
                    <li>
                        <i class="fa fa-check mr-5 text-ipmr-red hidden md:inline-block"></i>
                        <span>Sitio web totalmente responsivo</span>
                    </li>
                    <li>
                        <i class="fa fa-check mr-5 text-ipmr-red hidden md:inline-block"></i>
                        <span>SEO básico para mejorar la visibilidad en los motores de búsqueda.</span>
                    </li>
                    <li>
                        <i class="fa fa-check mr-5 text-ipmr-red hidden md:inline-block"></i>
                        <span>Capacitación para gestionar el contenido de tu sitio web.</span>
                    </li>
                </ul>
            </div>
            <div class="w-full md:w-1/2">
